...
export const translations = {
  en: {
    ...
    clipboardManualPaste: 'Clipboard is not accessible here — paste the link manually',
    clipboardPrefilled: 'Link pasted from your clipboard',
    qr: 'QR',
    purchase: 'Purchase',
  ...
  fa: {
    ...
    clipboardManualPaste: 'دسترسی به کلیپ‌بورد ممکن نیست — لینک را دستی جای‌گذاری کنید',
    clipboardPrefilled: 'لینک از کلیپ‌بورد وارد شد',
    qr: 'QR',
    purchase: 'خرید',
