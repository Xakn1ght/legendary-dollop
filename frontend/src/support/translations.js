export const translations = {
  en: {
    ...
    photoConfirmTitle: 'Send this photo?',
    photoConfirmSend: 'Send photo',
    photoConfirmCancel: 'Cancel',
  ...
  fa: {
    ...
    photoConfirmTitle: 'این عکس ارسال شود؟',
    photoConfirmSend: 'ارسال عکس',
    photoConfirmCancel: 'انصراف',
